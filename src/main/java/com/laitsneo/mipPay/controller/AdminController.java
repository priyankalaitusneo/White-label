...
import com.laitsneo.mipPay.dto.Client.ClientEditProfileDto;
import com.laitsneo.mipPay.dto.Client.ClientResponseDto;
import com.laitsneo.mipPay.dto.Client.HoldAmountDto;
import com.laitsneo.mipPay.dto.Client.LienAmountDTO;
import com.laitsneo.mipPay.dto.Client.LienResponseDTO;
import com.laitsneo.mipPay.dto.Client.PayoutFilterByCLientId;
import com.laitsneo.mipPay.dto.Client.PrefundDto;
...
import com.laitsneo.mipPay.entity.Client.LienAmount;
import com.laitsneo.mipPay.entity.Client.LienHistory;
import com.laitsneo.mipPay.response.AdminRoleResponseDto;
import com.laitsneo.mipPay.response.AdminSettlementHistoryResponseDTO;
import com.laitsneo.mipPay.response.AdminSettlementReportResponseDTO;
import com.laitsneo.mipPay.service.AdminRoleService;
import com.laitsneo.mipPay.service.ClientService;
import com.laitsneo.mipPay.service.LockedFundsService;
import com.laitsneo.mipPay.service.ReportService;
...
import com.laitsneo.mipPay.serviceImpl.Admin.AdminServiceImpl;
...
public class AdminController {
	...
	public ResponseEntity<ResponseDto> clientOnboard(@Valid @RequestBody Client data) {
		logger.info("POST /create-client → Request: {}", data);
		String resp = this.clientService.clientOnboard(data);
		logger.info("POST /create-client → Response: {}", resp);
		if (resp.equals("client onboarded successfully..!")) {
			ResponseDto response = ResponseDto.builder().response(resp).status("OK").statusCode(200).build();
