...
import com.laitsneo.whitelbl.exception.CustomBadRequestException;
import com.laitsneo.whitelbl.exception.CustomDuplicateEntryException;
import com.laitsneo.whitelbl.exception.CustomMethodArgumentNotValidException;
...
public class AdminServiceImpl implements AdminService {
    ...
    @Override
    public ResponseEntity<?> updateClientByAdmin(String userId, AdminClientUpdateDto  dto) {

        Map<String, Object> response = new HashMap<>();

        try {

            Optional<Client> optional = clientRepository.findById(userId);
            ...
            if (dto.getEmail() != null) {
                ...
                if (clientRepository.existsByEmailAndUserIdNot(dto.getEmail(), userId)) {
                    response.put("success", false);
            ...
            if (dto.getMobileNum() != null)
                client.setMobileNum(dto.getMobileNum());

            if (dto.getPassword() != null)
                client.setPassword(passwordEncoder.encode(dto.getPassword()));

            // ========== BANK DETAILS ==========
            if (dto.getAccountNum() != null)
                client.setAccountNum(dto.getAccountNum());
            ...
            if (dto.getMerchantType() != null)
                client.setMerchantType(dto.getMerchantType());

            // ========== WALLET ==========
            if (dto.getWalletBalance() != null)
                client.setWalletBalance(dto.getWalletBalance());
            ...
            response.put("data", updated.getUserId());
